...
const japaneseKeywords = [
  ...
  "北新地 夜ご飯", "北新地 晩ご飯", "北新地 ディナー", "北新地 和食 ディナー", "北新地 居酒屋 ディナー",
  "北新地 和食 居酒屋", "北新地 グルメ 居酒屋", "北新地 おいしい 居酒屋", "北新地 料理が美味しい 居酒屋", "北新地 ご飯 居酒屋",
  "北新地 飲み会後 ご飯", "北新地 二軒目 ご飯", "北新地 締め ご飯", "北新地 しめ ご飯", "北新地 仕事帰り ご飯",
  "北新地 仕事終わり ご飯", "北新地 遅い時間 居酒屋", "北新地 深夜 居酒屋", "北新地 夜中 ご飯", "北新地 夜中 食事",
  "北新地 駅近 居酒屋", "北新地駅 近く 居酒屋", "北新地駅 近く 和食", "北新地駅 ディナー", "北新地駅 夜ご飯",
  "西梅田 深夜 ご飯", "西梅田 夜ご飯", "西梅田 ディナー", "西梅田 居酒屋", "西梅田 和食",
  "西梅田駅 近く 居酒屋", "西梅田駅 近く 和食", "西梅田 飲み会後 ご飯", "西梅田 遅い時間 ご飯", "西梅田 仕事帰り ご飯",
  "梅田 深夜 ご飯", "梅田 深夜 食事", "梅田 夜遅く ご飯", "梅田 夜ご飯", "梅田 ディナー",
  "梅田 和食 居酒屋", "梅田 居酒屋 ディナー", "梅田 飲み会後 ご飯", "梅田 二軒目 ご飯", "梅田 締め ご飯",
  "大阪 深夜 ご飯", "大阪 深夜 食事", "大阪 夜遅く ご飯", "大阪 深夜 居酒屋", "大阪 和食 居酒屋",
  "大阪 居酒屋 ディナー", "大阪 グルメ 居酒屋", "大阪 飲み会後 ご飯", "大阪 締め ご飯", "大阪 仕事帰り ご飯",
  "堂島 深夜 ご飯", "堂島 夜ご飯", "堂島 ディナー", "堂島 居酒屋", "堂島 和食",
  "堂島 和食 居酒屋", "堂島 飲み会後 ご飯", "堂島 二軒目 ご飯", "堂島 仕事帰り ご飯", "堂島 遅い時間 ご飯",
  "大阪市北区 深夜 ご飯", "大阪市北区 夜ご飯", "大阪市北区 居酒屋", "大阪市北区 和食", "大阪市北区 ディナー",
  "大阪市北区 グルメ 居酒屋", "大阪市北区 飲み会後 ご飯", "北新地 一品料理", "北新地 和食 一品料理", "北新地 季節料理",
  "北新地 旬の食材", "北新地 レアカツ", "北新地 麻婆豆腐", "北新地 焼きそば", "北新地 レバー",
  "北新地 和牛ユッケ", "北新地 紹興酒", "北新地 カウンター 居酒屋", "堂島 一品料理", "堂島 季節料理",
  "深夜食堂 北新地", "深夜食堂 大阪", "しまながし 北新地", "深夜食堂 しまながし", "北新地 しまながし",
  "北新地 予約できる 居酒屋", "北新地 電話予約 居酒屋", "北新地 Instagram 予約", "北新地 18時から", "北新地 26時まで",
  "北新地 月曜定休 居酒屋", "北新地 ランチ 和食", "北新地 ランチ うなぎ", "堂島 ランチ 和食", "西梅田 ランチ 和食"
];
...
const englishKeywords = [
  ...
  "Kitashinchi izakaya", "Kitashinchi Japanese restaurant", "Kitashinchi Japanese dinner", "Kitashinchi dinner", "Kitashinchi food",
  "Kitashinchi restaurant", "Kitashinchi restaurant near station", "restaurant near Kitashinchi Station", "Japanese restaurant near Kitashinchi Station", "izakaya near Kitashinchi Station",
  "Nishi Umeda late night food", "Nishi Umeda dinner", "restaurant near Nishi Umeda Station", "izakaya near Nishi Umeda Station", "Japanese restaurant near Nishi Umeda Station",
  "Umeda late night food", "Umeda late dinner", "Umeda izakaya", "Umeda Japanese restaurant", "Umeda dinner after drinks",
  ...
  "Osaka izakaya dinner", "Osaka Japanese dinner", "Osaka Japanese restaurant", "Osaka local izakaya", "Osaka restaurant open late",
  "Dojima late night food", "Dojima dinner", "Dojima izakaya", "Dojima Japanese restaurant", "Dojima restaurant",
  "Dojima restaurant near Kitashinchi", "Kita ku Osaka dinner", "Kita ku Osaka izakaya", "Kita ku Osaka Japanese restaurant", "Japanese food in Kita Osaka",
  ...
  "Kitashinchi food guide", "Kitashinchi nightlife food", "Kitashinchi after drinks restaurant", "Kitashinchi second stop restaurant", "Kitashinchi meal after bar",
  "Osaka nightlife food", "Osaka after drinks restaurant", "Umeda after drinks food", "Dojima after drinks food", "Japanese restaurant open until late Osaka",
  "izakaya open until late Osaka", "Kitashinchi restaurant reservation", "Osaka restaurant reservation by phone", "Kitashinchi phone reservation", "Kitashinchi Instagram reservation",
  ...
  "late night meal Osaka", "late night meal Umeda", "late night meal Kitashinchi", "Japanese dinner near Umeda", "Osaka restaurant for late dinner"
];
